import { dayEvent, nightEvent } from "./data_en.js";
...
document.addEventListener('DOMContentLoaded', () => {
  if(url.includes("day")) {
    dayBtn.checked = true;
    banner.src = "./img/day-banner_en.png"
    setPage(dayEvent)
  } else if(url.includes("night")){
    nightBtn.checked = true;
    banner.src = "./img/night-banner_en.png"
    setPage(nightEvent);
  }
})

dayBtn.addEventListener("click", ()=>{
  location.href = "./event_en.html?type=day";
})
nightBtn.addEventListener("click", ()=>{
  location.href = "./event_en.html?type=night";
})
